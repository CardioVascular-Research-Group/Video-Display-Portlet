package edu.jhu.cvrg.portal.videodisplay.utility;
/*
...
public class ResourceUtility {
	...
	public static String getVideoURL(long videoId){
		
		FileEntry video = getVideo(videoId);
		...
		StringBundler sb = new StringBundler(13);
			...
			sb.append("/documents/");
			sb.append(video.getRepositoryId());
			sb.append(StringPool.SLASH);
			sb.append(video.getFolderId());
			sb.append(StringPool.SLASH);
			sb.append(HttpUtil.encodeURL(HtmlUtil.unescape(video.getTitle()), true));

			return sb.toString();
	}

	public static FileEntry getVideo(long videoId){
		FileEntry video = null;

		try {
			video = DLAppServiceUtil.getFileEntry(videoId);
	...
	public static void savePreferences(String folder, String video, String controlType, boolean fullscreen){
		LiferayFacesContext liferayFacesContext = LiferayFacesContext.getInstance();
		PortletPreferences prefs = liferayFacesContext.getPortletPreferences();
		try {
